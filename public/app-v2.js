...
function setupWelcomeScreen() {
    ...
    // --- Lógica de la primera diapositiva (Idioma y Edad) ---
    ...
    overlay.addEventListener('keydown', (e) => {
        ...
        if (e.key === 'Escape' && currentSlide === slides.length - 1) startBtn.click();
    });
...
function setupTextareaFeatures(textarea, counterElement, storageKey) {
    ...
    function updateCounter() {
        ...
        counterElement.classList.toggle('warn', remaining <= 20 && remaining > 0);
        counterElement.classList.toggle('danger', remaining <= 0);
    }
